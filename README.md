...
1. Pada `ReadWriteLock`, memungkinkan banyak thread untuk membaca data secara bersamaan tanpa adanya penulisan pada saat yang sama. Hal ini tentunya sesuai dengan notifikasi sehingga Rwlock lebih **EFISIEN** dibandingkan dengan Mutex
